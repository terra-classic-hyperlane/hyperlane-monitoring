...
| **Contracts & ownership** | Who controls each contract? | Inventory of core contracts and warp routes per chain with the on-chain owner and the admin: CosmWasm contract admin (Terra Classic), EIP-1967 proxy admin (BSC/Ethereum) or program upgrade authority (Solana). |
